<template>
  <div class="videoList-container">
    ...
    <div v-if="VideoCartList.length==0" class="no-data">暂无评论的视频,赶紧发表你的评论吧！！</div>
    <div class="page">
      <el-pagination
        background
...
export default {
  ...
  methods: {
    getVideoCartList(pageNum, pageSize) {
      ...
      axios
        .post("http://localhost:3004/videoPlay/getUserCommentVideo", {
          pageNum,
          pageSize,
          userId
        })
